...
const RAW = [
  ...
  { id: 'mcdo', name: "McDonald's PH", emoji: '🍟', color: '#da291c', tagline: "I'm lovin' the classics", rating: 4.9, time: '15–30 min', fee: 0, cuisines: ['Burgers', 'Fast Food', 'Meat', 'Chicken', 'Fried Chicken'], menu: [
    // Popular
    { name: '1-pc. Chicken McDo Solo', desc: '', price: 96, cat: 'Popular', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/4a547b3f3422f508cb9ec37b29ed82df.jpg?width=128&height=128' },
    { name: '1-pc. Chicken McDo w/ Fries Small Meal', desc: 'Comes with Small Fries and Drink', price: 169, cat: 'Popular', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/232acbaa7c0724f84d1bb78b999a238f.jpg?width=128&height=128' },
    { name: 'Crispy Chicken Fillet Ala King w/ Fries Small Meal', desc: '', price: 95, cat: 'Popular', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/6cd5c037c8583a923175cd7c01e60a6e.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets Solo', desc: '', price: 121, cat: 'Popular', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/079080abb4ec017564ab2b127f88297a.jpg?width=150&height=150' },
    { name: '10-pc. Chicken McNuggets', desc: '', price: 195, cat: 'Popular', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/1ff445fc69206947820c78fab577f853.jpg?width=150&height=150' },
    { name: 'BFF Fries', desc: '', price: 181, cat: 'Popular', emoji: '🍟', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/a0f24584d56b56de85f7e57d286b43b4.jpg?width=150&height=150' },
    // #BetterWithCoke
    { name: '1-pc. Chicken McDo Medium Meal', desc: 'Comes with a Drink', price: 116, cat: '#BetterWithCoke', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ac7ff7f76bcdba9589dda1af06b7dc96.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Sandwich w/ Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 175, cat: '#BetterWithCoke', emoji: '🍔', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ef0a9befaa923616daba3744e35b8cd5.jpg?width=150&height=150' },
    { name: 'Burger McDo w/ Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 145, cat: '#BetterWithCoke', emoji: '🍔', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/5a39e8b27b3da319d7d3672a56a36112.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets w/ Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 217, cat: '#BetterWithCoke', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/624130cf6b60dddb0ee3c7c755742db5.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Fillet Ala King Medium Meal', desc: '', price: 112, cat: '#BetterWithCoke', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/2c36e7d9d2e44345d6c635e13200ce93.jpg?width=150&height=150' },
    // New Offers
    { name: 'FIFA Collectible Cup Meal: 6-pc. Chicken McNuggets', desc: 'Comes with Fries, A&W Root Beer & Big Mac Sauce', price: 284, cat: 'New Offers', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/5b51b32b292a1643738613a3fcd48e12.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ Fries Happy Meal', desc: 'Comes with Small Fries & Drink', price: 214, cat: 'New Offers', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/17650b7f2c9eba231a247608b3c5617f.jpg?width=150&height=150' },
    { name: 'FIFA Collectible Cup Meal: Cheeseburger', desc: 'Comes with Fries and A&W Root Beer McFloat', price: 258, cat: 'New Offers', emoji: '🍔', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/b2e08916ff68304e3b9f3514a996fb16.jpg?width=150&height=150' },
    { name: 'FIFA GOALden Bundle: 10-pc. Chicken McNuggets', desc: 'Comes with BFF Fries, 2 A&W Root Beer & 2 Big Mac Sauce', price: 469, cat: 'New Offers', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/5242fcd6b983fb3b74c8c18ee391fbcd.jpg?width=150&height=150' },
    { name: 'A&W Root Beer McFloat and Fries Combo', desc: 'Comes with Fries and McFloat', price: 101, cat: 'New Offers', emoji: '🥤', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/d756bfa7db68c9d30a7415e1c397470f.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ Crispy Chicken Fillet and Drink Meal', desc: 'Comes with a Drink', price: 181, cat: 'New Offers', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/200a3eb6fb047132bde42b671a5d240d.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ Mushroom Pepper Steak and Drink Meal', desc: 'Comes with a Drink', price: 181, cat: 'New Offers', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/22930f09ac92bfea3a494ef89ba2dc09.jpg?width=150&height=150' },
    // Group Meals
    { name: 'FIFA GOALden Bundle: 10-pc. Chicken McNuggets', desc: 'Comes with BFF Fries, 2 A&W Root Beer & 2 Big Mac Sauce', price: 469, cat: 'Group Meals', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/5242fcd6b983fb3b74c8c18ee391fbcd.jpg?width=150&height=150' },
    { name: 'FIFA GOALden Bundle: 2 Cheeseburgers', desc: 'Comes with BFF Fries and 2 A&W Root Beer McFloat', price: 449, cat: 'Group Meals', emoji: '🍔', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/6195de5aa7a1cad764259f141cced76a.jpg?width=150&height=150' },
    { name: "Father's Day Bundle for 4", desc: 'Comes with 1-pc. Chicken McDo with Crispy Chicken Fillet Meal, Mushroom Pepper Steak Meal, and 2 Happy Meal Burger McDo with Drinks', price: 590, cat: 'Group Meals', emoji: '🍱', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/57f3232ef280b1107cc2a0483f450f24.jpg?width=150&height=150' },
    { name: "Father's Day Bundle for 3", desc: 'Comes with 1-pc. Chicken McDo with Crispy Chicken Fillet Meal, Mushroom Pepper Steak Meal, and 1 Happy Meal Burger McDo with Drink', price: 476, cat: 'Group Meals', emoji: '🍱', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/0d62f61952f2a4a583c6b020c0b66025.jpg?width=150&height=150' },
    { name: '10-pc. Chicken McNuggets', desc: '', price: 195, cat: 'Group Meals', emoji: '🍗', badge: 'Popular', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/1ff445fc69206947820c78fab577f853.jpg?width=150&height=150' },
    { name: '20-pc. Chicken McNuggets', desc: '', price: 382, cat: 'Group Meals', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/448fc3cbacda7a5ec3b0f5923d671883.jpg?width=150&height=150' },
    { name: 'McShare Bundle for 3', desc: 'Comes with 6 pcs Chicken McDo, 1 BFF Fries, 3 rice & 3 beverages', price: 615, cat: 'Group Meals', emoji: '🍱', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/029c986a3d2b7a3aa9dbc288818e75d4.jpg?width=150&height=150' },
    { name: 'McShare Bundle for 4', desc: 'Comes with 8 pcs Chicken McDo, 2 BFF Fries, 4 rice & 4 beverages', price: 855, cat: 'Group Meals', emoji: '🍱', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/cc097b4551c60795b39824f6f99b85fc.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McShare Box', desc: '', price: 515, cat: 'Group Meals', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/f26c998f88074683ed2cfdb7fec5d276.jpg?width=150&height=150' },
    { name: '8-pc. Chicken McShare Box', desc: '', price: 675, cat: 'Group Meals', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ed403ae0443b395f7026397327fc472e.jpg?width=150&height=150' },
    // Chicken
    { name: 'FIFA Collectible Cup Meal: 6-pc. Chicken McNuggets', desc: 'Comes with Fries, A&W Root Beer & Big Mac Sauce', price: 284, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/5b51b32b292a1643738613a3fcd48e12.jpg?width=150&height=150' },
    { name: 'FIFA GOALden Bundle: 10-pc. Chicken McNuggets', desc: 'Comes with BFF Fries, 2 A&W Root Beer & 2 Big Mac Sauce', price: 469, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/5242fcd6b983fb3b74c8c18ee391fbcd.jpg?width=150&height=150' },
    { name: 'FIFA World Cup Chicken McNuggets Meal', desc: 'Comes with Fries, A&W Root Beer McFloat & Big Mac Sauce', price: 242, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ae73687b6f7c4f4dd2cc4e21e854a9a3.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets w/ Fries and A&W Root Beer', desc: 'Comes with the Big Mac Sauce, Fries and Drink', price: 222, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/18b34158a7f27202cad1b896de827b04.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets w/ Big Mac Sauce', desc: 'Comes with the Big Mac Sauce', price: 120, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/c825b15247c4240cbe76a80f53f9a83e.jpg?width=150&height=150' },
    { name: '6-pc Chicken McNuggets Small Meal with Fries, Drink and Big Mac Sauce', desc: 'Comes with Small Fries and Drink', price: 187, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/b0075de106f69162ee3dd7bac636ba50.jpg?width=150&height=150' },
    { name: '6-pc Chicken McNuggets Large Meal with Fries, Drink and Big Mac Sauce', desc: 'Comes with Large Fries and Drink', price: 261, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/86da0bb53b1985c074f19ed860904042.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets with Rice and Small Drink and Big Mac Sauce', desc: 'Comes with a Drink', price: 181, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/9d20eeac0b826f798e6832907942570c.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets with Rice and Medium Drink and Big Mac Sauce', desc: 'Comes with a Drink', price: 192, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/e4ebdd57a931f8ba173b7f0c3ece7a02.jpg?width=150&height=150' },
    { name: '6-pc Chicken McNuggets Large Meal with Rice, Drink and Big Mac Sauce', desc: 'Comes with a Drink', price: 201, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/94a58df880610c5f075a0df690f6a85b.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo Solo', desc: '', price: 96, cat: 'Chicken', emoji: '🍗', badge: 'Popular', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/4a547b3f3422f508cb9ec37b29ed82df.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ Fries Small Meal', desc: 'Comes with Small Fries and Drink', price: 169, cat: 'Chicken', emoji: '🍗', badge: 'Popular', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/232acbaa7c0724f84d1bb78b999a238f.jpg?width=150&height=150' },
    { name: '1-pc. Spicy Chicken McDo w/ Crispy Chicken Fillet and Drink Meal', desc: 'Comes with a Drink', price: 187, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ae368bc85644d43d6982728131ab6095.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ Crispy Chicken Fillet and Drink Meal', desc: 'Comes with a Drink', price: 181, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/200a3eb6fb047132bde42b671a5d240d.jpg?width=150&height=150' },
    { name: '1-pc. Spicy Chicken McDo w/ Mushroom Pepper Steak and Drink Meal', desc: 'Comes with a Drink', price: 187, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/c38107af2a72ff56290844ae459f48a6.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ Mushroom Pepper Steak and Drink Meal', desc: 'Comes with a Drink', price: 181, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/22930f09ac92bfea3a494ef89ba2dc09.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo Medium Meal', desc: 'Comes with a Drink', price: 120, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ac7ff7f76bcdba9589dda1af06b7dc96.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ Fries Medium Meal', desc: '', price: 207, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/d6a5664943e9b52a05c29673f73599b9.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo Large Meal', desc: 'Comes with a Drink', price: 129, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ac7ff7f76bcdba9589dda1af06b7dc96.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ Fries Large Meal', desc: 'Comes with Large Fries & Drink', price: 246, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/24e5246aaf290c373013cb6e647164c3.jpg?width=150&height=150' },
    { name: '1-pc Spicy Chicken McDo with Small Drink', desc: 'Comes with a Drink', price: 115, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/336279f6fe51d03904615aa17440afbc.jpg?width=150&height=150' },
    { name: '1-pc Spicy Chicken McDo', desc: '', price: 102, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/b1ea72212b201f75908937b77203effe.jpg?width=150&height=150' },
    { name: '1-pc Spicy Chicken McDo and Medium Drink', desc: 'Comes with a Drink', price: 126, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/1b228fc9206371b326a20c84e150418e.jpg?width=150&height=150' },
    { name: '1-pc Spicy Chicken McDo with Large Drink', desc: 'Comes with a Drink', price: 135, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/8ab91069960420467333b507d51257ac.jpg?width=150&height=150' },
    { name: '1-pc Spicy Chicken McDo with Small Fries and Drink', desc: 'Comes with Small Fries & Drink', price: 175, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/6252af7b1bdea45696cd348c035f5a24.jpg?width=150&height=150' },
    { name: '1-pc Spicy Chicken McDo with Medium Fries and Drink', desc: 'Comes with Medium Fries & Drink', price: 213, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/25124184ddf76701236f77faa0180a34.jpg?width=150&height=150' },
    { name: '1-pc Spicy Chicken McDo with Large Fries and Drink', desc: 'Comes with Large Fries & Drink', price: 252, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/68d1124706c54eb5e50f74c70e2442f5.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ McSpaghetti Solo', desc: '', price: 161, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/cd0c7a393a22efaf01f2d9672439328c.jpg?width=150&height=150' },
    { name: '1-pc Chicken McDo with McSpaghetti and Small Drink', desc: 'Comes with a Drink', price: 192, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/4af8c81ca89fc354c9113716c4016915.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ McSpaghetti Medium Meal', desc: 'Comes with a Drink', price: 203, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/4af8c81ca89fc354c9113716c4016915.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ McSpaghetti Large Meal', desc: 'Comes with a Drink', price: 212, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/4af8c81ca89fc354c9113716c4016915.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ McSpaghetti & Fries Small Meal', desc: 'Comes with Small Fries and Drink', price: 235, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/d3b97513f0ddcb975ba0b51126e02ce7.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ McSpaghetti & Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 273, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/778e3db5e00fc142a3f9cb7cb75666c7.jpg?width=150&height=150' },
    { name: '1-pc. Chicken McDo w/ McSpaghetti & Fries Large Meal', desc: 'Comes with Large Fries & Drink', price: 312, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/f61860193b787c4f3a4c472609d251ce.jpg?width=150&height=150' },
    { name: '1-pc Spicy Chicken McDo with McSpaghetti', desc: '', price: 167, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/965fed3407a8a3096f036a5ed25f96ac.jpg?width=150&height=150' },
    { name: '1-pc. Spicy Chicken McDo w/ McSpaghetti & Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 279, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/18cde68d899436e011f569dd40fba5e7.jpg?width=150&height=150' },
    { name: '1-pc. Spicy Chicken McDo w/ McSpaghetti & Fries Small Meal', desc: 'Comes with Small Fries & Drink', price: 241, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/b775291dffb95e84e81463602d543f69.jpg?width=150&height=150' },
    { name: '1-pc. Spicy Chicken McDo w/ McSpaghetti & Fries Large Meal', desc: 'Comes with Large Fries & Drink', price: 318, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/73ead963775872d01f8be93c6c8d23da.jpg?width=150&height=150' },
    { name: '2-pc. Chicken McDo Solo', desc: '', price: 191, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/5f9934f8171ce8ced057d8ba13addb80.jpg?width=150&height=150' },
    { name: '2-pc Chicken McDo with Small Drink', desc: 'Comes with a Drink', price: 219, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/a3227014f7081e505a4338f65514b9ed.jpg?width=150&height=150' },
    { name: '2-pc. Chicken McDo Medium Meal', desc: 'Comes with a Drink', price: 230, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/a3227014f7081e505a4338f65514b9ed.jpg?width=150&height=150' },
    { name: '2-pc. Chicken McDo Large Meal', desc: 'Comes with a Drink', price: 239, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/a3227014f7081e505a4338f65514b9ed.jpg?width=150&height=150' },
    { name: '2-pc. Chicken McDo w/ Fries Small Meal', desc: 'Comes with Small Fries and Drink', price: 259, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/e1431bd19d8c8a61a787ae76f0bdba2a.jpg?width=150&height=150' },
    { name: '2-pc. Chicken McDo w/ Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 297, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/17a3485bf32aa1a88e12659e48cafdfc.jpg?width=150&height=150' },
    { name: '2-pc. Chicken McDo w/ Fries Large Meal', desc: 'Comes with Large Fries & Drink', price: 336, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/cade60761ca47a63b46725eec4c412b0.jpg?width=150&height=150' },
    { name: '2-pc Spicy Chicken McDo', desc: '', price: 203, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/b5e03b1dd2a594722b02230be40435d9.jpg?width=150&height=150' },
    { name: '2-pc Spicy Chicken McDo with Medium Drink', desc: 'Comes with a Drink', price: 242, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/8b73e982218e792d254fbd816ca2e24f.jpg?width=150&height=150' },
    { name: '2-pc Spicy Chicken McDo and Small Drink', desc: 'Comes with a Drink', price: 231, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/67d4ec7e8f001826101e448898da3a6f.jpg?width=150&height=150' },
    { name: '2-pc Spicy Chicken McDo with Large Drink', desc: 'Comes with a Drink', price: 251, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/3e5f15779b37744e2ed1a9eefa44ea6d.jpg?width=150&height=150' },
    { name: '2-pc Spicy Chicken McDo & Fries Small Meal', desc: 'Comes with Small Fries & Drink', price: 271, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/a56cb735f0240b4d78aa8fb933e9fd83.jpg?width=150&height=150' },
    { name: '2-pc. Spicy Chicken McDo & Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 309, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/fb5b6d041d6ac4a56186b8dac6b33e9b.jpg?width=150&height=150' },
    { name: '2-pc. Spicy Chicken McDo & Fries Large Meal', desc: 'Comes with Large Fries & Drink', price: 348, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/fe57a4cdc1b74b5561fa733acf0c33d3.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McShare Box', desc: '', price: 515, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/f26c998f88074683ed2cfdb7fec5d276.jpg?width=150&height=150' },
    { name: '8-pc. Chicken McShare Box', desc: '', price: 675, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ed403ae0443b395f7026397327fc472e.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Fillet Ala King Solo', desc: '', price: 95, cat: 'Chicken', emoji: '🍗', badge: 'Popular', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/1e40530d907aa4f7bac0394576e8735f.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Fillet Ala King w/ Fries Small Meal', desc: 'Comes with Small Fries and Drink', price: 142, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/6cd5c037c8583a923175cd7c01e60a6e.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Fillet Ala King w/ Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 180, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/2c36e7d9d2e44345d6c635e13200ce93.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Fillet Solo', desc: '', price: 88, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/3edd2f1d3d17cbd3c5b44c2884091f4f.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Fillet Ala King w/ Fries Large Meal', desc: 'Comes with Large Fries & Drink', price: 219, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/d5e8ec18ae2e86635419a9b176f79c6a.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Fillet w/ Fries Small Meal', desc: 'Comes with Small Fries and Drink', price: 135, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/9a45817abf530bfd2994526c5ef6ce9d.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Fillet w/ Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 173, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ffd140d4c15fc66db2ba2ffaf72d47a6.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Fillet w/ Fries Large Meal', desc: 'Comes with Large Fries & Drink', price: 212, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/585a2ce9485e6602307b8ae302700a3d.jpg?width=150&height=150' },
    { name: 'Golden Curry Fillet with Small Fries and Drink', desc: 'Comes with Small Fries & Drink', price: 146, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/d4e57cb9dcc71af677d6dd65e1236a49.jpg?width=150&height=150' },
    { name: 'Golden Curry Fillet with Medium Fries and Drink', desc: 'Comes with Medium Fries & Drink', price: 184, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/b1867c79986322705856100b75d1abe4.jpg?width=150&height=150' },
    { name: 'Golden Curry Fillet with Large Fries and Drink', desc: 'Comes with Large Fries & Drink', price: 223, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/387aa2288a2ce5d44287ac3315f9fb7e.jpg?width=150&height=150' },
    { name: 'Golden Curry Fillet with Medium Drink', desc: 'Comes with a Drink', price: 116, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/58e7a470d92fc1ea071d531ef2f4bd86.jpg?width=150&height=150' },
    { name: 'Golden Curry Fillet with Small Drink', desc: 'Comes with a Drink', price: 101, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/3bd9b6ef76d8f38627158d82e7f9a289.jpg?width=150&height=150' },
    { name: 'Golden Curry Fillet with Rice', desc: 'Enjoy this new product!', price: 98, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/6f3e558f37e6c3c0df31da3a6d4eaf0b.jpg?width=150&height=150' },
    { name: 'Golden Curry Fillet with Large Drink', desc: 'Comes with a Drink', price: 125, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/50fb2ee586d97ddffdecfa75a8f591ad.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets with Small Fries and Drink and Cajun Sauce', desc: 'Comes with the Cajun Sauce', price: 187, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/b0075de106f69162ee3dd7bac636ba50.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets with Medium Fries and Drink and Cajun Sauce', desc: 'Comes with the Cajun Sauce', price: 222, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/af588848bb2308edc19ca5aff972efb3.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets with Large Fries and Drink and Cajun Sauce', desc: 'Comes with the Cajun Sauce', price: 261, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/3a0c1171078920a7c198649866af7de9.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets with Rice and Small Drink and Cajun Sauce', desc: 'Comes with the Cajun Sauce', price: 181, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ab9955657b957d36c5d15d8fdc625587.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets with Rice and Medium Drink and Cajun Sauce', desc: 'Comes with the Cajun Sauce', price: 192, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/f49340a150c4c5cf12b67771032b9e58.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets with Rice and Large Drink and Cajun Sauce', desc: 'Comes with the Cajun Sauce', price: 201, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/dc21a68e2e73017ce2565c13a40f3c08.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets w/ Fries Small Meal', desc: 'Comes with Small Fries and Drink', price: 185, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/a8eba8a05f946d35e92d97d456b7b46e.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets w/ Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 223, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/624130cf6b60dddb0ee3c7c755742db5.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets w/ Fries Large Meal', desc: 'Comes with Large Fries & Drink', price: 262, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/e48a010fbaa091b55798fc4a4ed9e356.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets w/ Rice Small Meal', desc: 'Comes w/ Small Rice and Drink', price: 182, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/e1c34acc34347cf586dd75cca41314bc.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets w/ Rice Medium Meal', desc: 'Comes with Medium Rice & Drink', price: 193, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/e1c34acc34347cf586dd75cca41314bc.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets w/ Rice Large Meal', desc: 'Comes with Large Rice & Drink', price: 202, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/e1c34acc34347cf586dd75cca41314bc.jpg?width=150&height=150' },
    { name: '6-pc Chicken McNuggets Meal A la Carte with Cajun Sauce', desc: 'Comes with the Cajun Sauce', price: 120, cat: 'Chicken', emoji: '🍗', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/7b98781d566b9b421ce7c6393231cc5f.jpg?width=150&height=150' },
    { name: '6-pc. Chicken McNuggets Solo', desc: '', price: 121, cat: 'Chicken', emoji: '🍗', badge: 'Popular', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/079080abb4ec017564ab2b127f88297a.jpg?width=150&height=150' },
    ...
    // Burgers
    { name: 'FIFA Collectible Cup Meal: Cheeseburger', desc: 'Comes with Fries and A&W Root Beer McFloat', price: 258, cat: 'Burgers', emoji: '🍔', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/b2e08916ff68304e3b9f3514a996fb16.jpg?width=150&height=150' },
    { name: 'FIFA GOALden Bundle: 2 Cheeseburgers', desc: 'Comes with BFF Fries and 2 A&W Root Beer McFloat', price: 449, cat: 'Burgers', emoji: '🍔', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/6195de5aa7a1cad764259f141cced76a.jpg?width=150&height=150' },
    { name: 'Triple Cheeseburger w/ Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 303, cat: 'Burgers', emoji: '🍔', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/e105131bda4c24881562f4310414ea5d.jpg?width=150&height=150' },
    { name: 'Triple Cheeseburger w/ Fries Large Meal', desc: 'Comes with Large Fries & Drink', price: 342, cat: 'Burgers', emoji: '🍔', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/3821d71c10433d691a06756ddfd3abf6.jpg?width=150&height=150' },
    { name: 'Triple Cheeseburger w/ Fries Small Meal', desc: 'Comes with Small Fries & Drink', price: 265, cat: 'Burgers', emoji: '🍔', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/99a59455b76da29ccf0e08add23d2a88.jpg?width=150&height=150' },
    { name: 'Crispy Chicken Sandwich w/ Fries Medium Meal', desc: 'Comes with Medium Fries & Drink', price: 180, cat: 'Burgers', emoji: '🍔', img: 'https://images.deliveryhero.io/image/menu-import-gateway-prd/regions/AS/chains/mcd_philippines/ef0a9befaa923616daba3744e35b8cd5.jpg?width=150&height=150' },
